...
<html>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="view_supervisor.php" class="logo">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>Supervisor <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-edit"></i> <span>SPJ</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="pages/forms/general.html"><i class="fa fa-angle-double-right"></i>Create New SPJ</a></li>
                                <li><a href="pages/forms/advanced.html"><i class="fa fa-angle-double-right"></i>Edit SPJ</a></li>
                                <li><a href="pages/forms/editors.html"><i class="fa fa-angle-double-right"></i>Delete SPJ</a></li>
                            </ul>
                        </li>
						<li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/UI/general.html"><i class="fa fa-angle-double-right"></i>Driver by Name</a></li>
                                <li><a href="pages/UI/icons.html"><i class="fa fa-angle-double-right"></i>Track All Drivers</a></li>
							<!--      
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/tables/simple.html"><i class="fa fa-angle-double-right"></i>Inbox<small class="badge pull-right bg-yellow">12</small></a></li>
                                <li><a href="pages/tables/data.html"><i class="fa fa-angle-double-right"></i>Create Notification</a></li>
                            </ul>
                        </li>
						<li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="pages/charts/morris.html"><i class="fa fa-angle-double-right"></i>Daily</a></li>
                                <li><a href="pages/charts/flot.html"><i class="fa fa-angle-double-right"></i>Monthly</a></li>
                                <li><a href="pages/charts/inline.html"><i class="fa fa-angle-double-right"></i>Yearly</a></li>
                            </ul>
                        </li>
